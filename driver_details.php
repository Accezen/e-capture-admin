...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2 side-nav">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <li>
                        <a href="driver_management.php" class="nav-link active">
                            <div class="nav-item">
                                <div class="nav-icon">
        ...
        <!--Edit Driver Modal -->
        <div class="modal fade" id="editDriver" tabindex="-1" aria-labelledby="editDriver" aria-hidden="true">
        ...
        $(document).ready(function() {
            ...
            onSnapshot(docRef,(snapshot) => {
                ...
                $(".nav-r-container").append(`
                    <div class="r-nav-item" >
                        <a href="#editDriver" data-bs-toggle="modal" data-bs-target="#editDriver">Update Account's Info</a>
                    </div>
                    <div class="r-nav-item" >
                ...
                (`
                    ...
                    <div class="sub-detail">
                        <div class="ind-detail">
                            ...
                            <div class="detail-right">
                                <span class="d-email" ><a href="mailto:${ data.email }">${ data.email }</a></span>
                            </div>
                        </div>
                    </div>
                `)
            ...
            .then((doc) => {
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="driver_details.php?id=${id}" method="post" id="editDriver">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control" name = "mobile" id="mobile" placeholder = "e.g. +639123456789" value="${data.mobile}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-6" required>
                                        <label for="vehicle" class="form-label">Vehicle Type</label>
                                        <input type="text" class="form-control" name ="vehicle" id="vehicle" value="${data.vehicle}" required>  
                                </div> 
                                <div class="col-sm-6">
                                    <label for="plate" class="form-label">Plate Number</label>
                                    <input type="text" class="form-control" name ="plate" id="plate" value="${data.plate}" required>
                                </div> 
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <input type="email" class="form-control" name = "email" id="email" placeholder="email@email.com" value="${data.email}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <input type="password" class="form-control" name = "password" id="password" autocomplete="on" value="${data.password}" required>
                                </div>
                            </div>

                            <div class="modal-footer">
                                <button type="button" class="btn btn-cancel" data-bs-dismiss="modal">Cancel</button>
                                <button type="submit" class="btn btn-add UpdateData">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
                `)
                async function updateData (first_name, last_name, address, email, mobile, password, plate, vehicle){
                    const data = {
            ...
            let collectionRef = collection(db, "driver", id , "feedbacks");
                ...
                $("#tbl-res").append
                    ...
                    querySnapshot.forEach((doc) => {
                        ...
                        $("tbody").append
                            (`
                                <tr>
                                    <td  class ="clickable" data-href="view_passenger_pane1.php?id=${data.passenger}" >${doc.data().passengerName}</td>
                                    <td  class ="clickable" data-href="view_passenger_pane1.php?id=${data.passenger}">${ comment }</td>
                                    <td  class ="clickable" data-href="view_passenger_pane1.php?id=${data.passenger}">${ finalDate }</td>
                                    <td class="${rem} clickable" data-href="view_passenger_pane1.php?id=${data.passenger}">${ rating }</td>
                                </tr>  
                            `);
                    });
