    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12 container-main pre-load">
                ...
                <span class="reg-count">No. of registered passengers:</span>
        ...
        $(document).ready(function() {
            ...
            onSnapshot(colRef,(snapshot) => {
                ...
                snapshot.forEach((passenger) => {
                    ...
                    var statusCss = (passenger.data().status == 'active') ? 'status-active' : 'status-inactive';
                    ...
                    $("tbody").append(`
                            <tr>
                                ...
                                <td class = "${statusCss} clickable" data-href="passenger_details.php?id=${passenger.id}">${passenger.data().status}</td>
                            </tr>  
                ...
                $(document).on('click', '.delete-btn', function(){
                    ...
                    const delRef = doc(db, "driver", driverId );
