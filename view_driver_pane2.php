                ...
                $("#tbl-res").append
                    ...
                    querySnapshot.forEach((doc) => {
                        ...
                        $("tbody").append
                            (`
                                <tr>
                                    <td  class ="clickable" data-href="view_passenger_pane2.php?id=${data.passenger}" >${doc.data().passengerName}</td>
                                    <td  class ="clickable" data-href="view_passenger_pane2.php?id=${data.passenger}">${ comment }</td>
                                    <td  class ="clickable" data-href="view_passenger_pane2.php?id=${data.passenger}">${ finalDate }</td>
                                    <td class="${rem} clickable" data-href="view_passenger_pane2.php?id=${data.passenger}">${ rating }</td>
                                </tr>  
                            `);
                    });
