                ...
                $("#tbl-scan").append
                    ...
                    querySnapshot.forEach((doc) => {
                        ...
                        $("tbody").append
                            (`
                                <tr>
                                    <td class="clickable" data-href="view_driver_pane1.php?id=${ data.driver }">${d_name}</td>
                                    <td class="clickable" data-href="view_driver_pane1.php?id=${ data.driver }">${ data.vehicle }</td>
                                    <td class="clickable" data-href="view_driver_pane1.php?id=${ data.driver }">${ data.plate }</td>
                                    <td class="clickable" data-href="view_driver_pane1.php?id=${ data.driver }">${ finalDate }</td>
                                    <td class="clickable" data-href="view_driver_pane1.php?id=${ data.driver }">${ data.location }</td>
                                    <td class="${ statusCss } clickable" data-href="view_driver_pane1.php?id=${ data.driver }">${ data.status }</td>
                                    <td clickable" data-href="view_driver_pane1.php?id=${ data.driver }">${ data.danger }</td>
                                </tr>  
                            `);
                    });
                ...
                querySnapshot.forEach((doc) => {
                    ...
                    $("#tbody1").append
                        (`
                            <tr>
                                <td class="clickable" data-href="view_driver_pane1.php?id=${ data.driver }">${d_name}</td>
                                <td class="clickable" data-href="view_driver_pane1.php?id=${ data.driver }">${ data.driverVehicle }</td>
                                <td class="clickable" data-href="view_driver_pane1.php?id=${ data.driver }">${ data.driverPlate }</td>
                                <td class="clickable" data-href="view_driver_pane1.php?id=${ data.driver }">${ finalDate }</td>
                                <td class="clickable" data-href="view_driver_pane1.php?id=${ data.driver }">${ comment }</td>
                                <td class="${ rem } clickable" data-href="view_driver_pane1.php?id=${ data.driver }">${ ratings }</td>
                            </tr>  
